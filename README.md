...
This repository contains the completed tasks for the CodeAlpha Data Analytics Internship Program.
...
│
├── Task_1_EDA
│   └── CodeAlpha_Task_1_EDA.ipynb
│
├── Task_2_Data_Visualization
│   └── CodeAlpha_Task_2_Data_Visualization.ipynb
│
...
5. Helpfulness vs Review Score (Scatter Plot)
